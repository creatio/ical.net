...
namespace ical.NET.UnitTests
{
    ...
    public class TodoTest
    {
        ...
        public void TestMethod(string calendarString, IList<KeyValuePair<CalDateTime, bool>> incoming)
        {
        ...
        {
            TestMethod(calendarString, incoming);
        }
        ...
        public static IEnumerable<ITestCaseData> ActiveTodo_TestCases()
        {
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo1), testVals)
                .SetName("Todo1");
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo2), testVals)
                .SetName("Todo2");
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo3), testVals).SetName("Todo3");
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo5), testVals).SetName("Todo5");
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo6), testVals).SetName("Todo6");
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo7), testVals).SetName("Todo7");
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo8), testVals).SetName("Todo8");
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo9), testVals).SetName("Todo9");
        }
        ...
        public static IEnumerable<ITestCaseData> CompletedTodo_TestCases()
        {
            ...
            yield return new TestCaseData(Encoding.UTF8.GetString(IcsFiles.Todo4), testVals).SetName("Todo4");
        }

        [Test, Category("Todo")]
        public void Todo7_1()
        {
            var iCal = Calendar.LoadFromStream(new StringReader(Encoding.UTF8.GetString(IcsFiles.Todo7)))[0];
            var todo = iCal.Todos[0];
